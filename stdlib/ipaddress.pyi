...
def collapse_addresses[_N: (IPv4Network, IPv6Network)](addresses: Iterable[_N]) -> Iterator[_N]: ...
@overload
def get_mixed_type_key[_A: (IPv4Address, IPv6Address)](obj: _A) -> tuple[int, _A]: ...
@overload
