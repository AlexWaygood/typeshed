...
class type:
    ...
    @overload
    def __new__(cls, __name: str, __bases: tuple[type, ...], __namespace: dict[str, Any], **kwds: Any) -> type: ...
...
class int:
    ...
    def to_bytes(self, length: int = 1, byteorder: Literal["little", "big"] = "big", *, signed: bool = False) -> bytes: ...
    @classmethod
    def from_bytes(
        cls,
...
class str(Sequence[str]):
    ...
    def startswith(self, __prefix: str | tuple[str, ...], __start: int | None = ..., __end: int | None = ...) -> bool: ...
...
class bytes(Sequence[int]):
    ...
    @overload
    def __new__(cls) -> Self: ...
    def index(self, __sub: ReadableBuffer | int, __start: int | None = ..., __end: int | None = ...) -> int: ...
    def __len__(self) -> int: ...
