...
def abs[_T](x: SupportsAbs[_T], /) -> _T: ...
...
if sys.version_info >= (3, 10):
    def aiter[_SupportsAnextT: SupportsAnext[Any]](async_iterable: SupportsAiter[_SupportsAnextT], /) -> _SupportsAnextT: ...
    ...
    def anext[_AwaitableT: Awaitable[Any]](i: _SupportsSynchronousAnext[_AwaitableT], /) -> _AwaitableT: ...
    @overload
    async def anext[_T, _VT](i: SupportsAnext[_T], default: _VT, /) -> _T | _VT: ...
...
@overload
def getattr[_T](o: object, name: str, default: _T, /) -> Any | _T: ...
...
@overload
def iter[_SupportsNextT: SupportsNext[Any]](object: SupportsIter[_SupportsNextT], /) -> _SupportsNextT: ...
@overload
def iter[_T](object: _GetItemIterable[_T], /) -> Iterator[_T]: ...
@overload
def iter[_T](object: Callable[[], _T | None], sentinel: None, /) -> Iterator[_T]: ...
@overload
def iter[_T](object: Callable[[], _T], sentinel: object, /) -> Iterator[_T]: ...
...
@overload
def max[_T](iterable: Iterable[SupportsRichComparisonT], /, *, key: None = None, default: _T) -> SupportsRichComparisonT | _T: ...
@overload
...
@overload
def min[_T](iterable: Iterable[SupportsRichComparisonT], /, *, key: None = None, default: _T) -> SupportsRichComparisonT | _T: ...
@overload
def min(iterable: Iterable[_T1], /, *, key: Callable[[_T1], SupportsRichComparison], default: _T2) -> _T1 | _T2: ...
@overload
def next[_T](i: SupportsNext[_T], /) -> _T: ...
@overload
def next[_T, _VT](i: SupportsNext[_T], default: _VT, /) -> _T | _VT: ...
...
@overload
def round[_T](number: _SupportsRound1[_T], ndigits: None = None) -> _T: ...
@overload
def round[_T](number: _SupportsRound2[_T], ndigits: SupportsIndex) -> _T: ...
...
@overload
def sum[_SupportsSumNoDefaultT: _SupportsSumWithNoDefaultGiven](iterable: Iterable[_SupportsSumNoDefaultT], /) -> _SupportsSumNoDefaultT | Literal[0]: ...
@overload
def sum[_AddableT1: SupportsAdd[Any, Any], _AddableT2: SupportsAdd[Any, Any]](iterable: Iterable[_AddableT1], /, start: _AddableT2) -> _AddableT1 | _AddableT2: ...
