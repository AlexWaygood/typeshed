...
class bytes(Sequence[int]):
    ...
    def center(self, __width: int, __fillchar: bytes = b" ") -> bytes: ...
    def count(
    ...
    def ljust(self, __width: int, __fillchar: bytes = b" ") -> bytes: ...
    ...
    def replace(self, __old: ReadableBuffer, __new: ReadableBuffer, __count: int = -1) -> bytes: ...
    def rfind(
        self, __sub: ReadableBuffer | int, __start: int | None = ..., __end: int | None = ...
    ) -> int: ...
    def rindex(
    ...
    def rjust(self, __width: int, __fillchar: bytes = b" ") -> bytes: ...
    def rpartition(self, __sep: ReadableBuffer) -> tuple[bytes, bytes, bytes]: ...
    def rsplit(self, sep: ReadableBuffer | None = None, maxsplit: int = -1) -> list[bytes]: ...
    def rstrip(self, __bytes: ReadableBuffer | None = None) -> bytes: ...
    def split(self, sep: ReadableBuffer | None = None, maxsplit: int = -1) -> list[bytes]: ...
