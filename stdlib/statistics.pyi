...
def mean[_NumberT: (float, Decimal, Fraction)](data: Iterable[_NumberT]) -> _NumberT: ...

if sys.version_info >= (3, 10):
    def harmonic_mean[_NumberT: (float, Decimal, Fraction)](data: Iterable[_NumberT], weights: Iterable[_Number] | None = None) -> _NumberT: ...

else:
    def harmonic_mean[_NumberT: (float, Decimal, Fraction)](data: Iterable[_NumberT]) -> _NumberT: ...

def median[_NumberT: (float, Decimal, Fraction)](data: Iterable[_NumberT]) -> _NumberT: ...
...
def mode[_HashableT: Hashable](data: Iterable[_HashableT]) -> _HashableT: ...
def multimode[_HashableT: Hashable](data: Iterable[_HashableT]) -> list[_HashableT]: ...
...
def quantiles[_NumberT: (float, Decimal, Fraction)](
