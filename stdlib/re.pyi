...
@final
class Pattern[AnyStr: (bytes, str)]:
    @property
    def flags(self) -> int: ...
    @property
...
@overload
def compile[AnyStr: (bytes, str)](pattern: AnyStr, flags: _FlagsType = 0) -> Pattern[AnyStr]: ...
@overload
def compile[AnyStr: (bytes, str)](pattern: Pattern[AnyStr], flags: _FlagsType = 0) -> Pattern[AnyStr]: ...
@overload
...
def escape[AnyStr: (bytes, str)](pattern: AnyStr) -> AnyStr: ...
def purge() -> None: ...
