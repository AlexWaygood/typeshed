...
@final
class DirEntry[AnyStr: (bytes, str)]:
...
@overload
def fspath[AnyStr: (bytes, str)](path: PathLike[AnyStr]) -> AnyStr: ...
...
@overload
def getenv[_T](key: str, default: _T) -> str | _T: ...

if sys.platform != "win32":
    @overload
    def getenvb(key: bytes) -> bytes | None: ...
    @overload
    def getenvb[_T](key: bytes, default: _T) -> bytes | _T: ...
...
def readlink[AnyStr: (bytes, str)](path: GenericPath[AnyStr], *, dir_fd: int | None = None) -> AnyStr: ...
...
@final
class _ScandirIterator[AnyStr: (bytes, str)]:
...
@overload
def scandir[AnyStr: (bytes, str)](path: GenericPath[AnyStr]) -> _ScandirIterator[AnyStr]: ...
