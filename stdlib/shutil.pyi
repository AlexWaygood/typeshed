...
def copyfile[_StrOrBytesPathT: StrOrBytesPath](src: StrOrBytesPath, dst: _StrOrBytesPathT, *, follow_symlinks: bool = True) -> _StrOrBytesPathT: ...
...
@overload
def which[_StrPathT: StrPath](cmd: _StrPathT, mode: int = 1, path: StrPath | None = None) -> str | _StrPathT | None: ...
@overload
