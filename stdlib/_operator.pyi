...
def abs[_T](a: SupportsAbs[_T], /) -> _T: ...
def add(a: Any, b: Any, /) -> Any: ...
def and_(a: Any, b: Any, /) -> Any: ...
def floordiv(a: Any, b: Any, /) -> Any: ...
def index(a: SupportsIndex, /) -> int: ...
def inv[_T_co](a: _SupportsInversion[_T_co], /) -> _T_co: ...
def invert[_T_co](a: _SupportsInversion[_T_co], /) -> _T_co: ...
def lshift(a: Any, b: Any, /) -> Any: ...
def mod(a: Any, b: Any, /) -> Any: ...
def mul(a: Any, b: Any, /) -> Any: ...
def matmul(a: Any, b: Any, /) -> Any: ...
def neg[_T_co](a: _SupportsNeg[_T_co], /) -> _T_co: ...
def or_(a: Any, b: Any, /) -> Any: ...
def pos[_T_co](a: _SupportsPos[_T_co], /) -> _T_co: ...
...
@overload
def getitem[_T](a: Sequence[_T], b: slice, /) -> Sequence[_T]: ...
@overload
...
if sys.version_info >= (3, 14):
    ...
    def is_not_none[_T](a: _T | None, /) -> TypeIs[_T]: ...
