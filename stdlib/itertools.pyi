...
class count[_N: (int, float, SupportsFloat, SupportsInt, SupportsIndex, SupportsComplex)]:
    @overload
...
def tee[_T](iterable: Iterable[_T], n: int = 2, /) -> tuple[Iterator[_T], ...]: ...

class zip_longest[_T_co]:
...
class combinations_with_replacement[_T_co]:
    @overload
