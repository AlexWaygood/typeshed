...
if sys.version_info < (3, 12):
    def module_for_loader[**_P](fxn: Callable[_P, types.ModuleType]) -> Callable[_P, types.ModuleType]: ...
    def set_loader[**_P](fxn: Callable[_P, types.ModuleType]) -> Callable[_P, types.ModuleType]: ...
    def set_package[**_P](fxn: Callable[_P, types.ModuleType]) -> Callable[_P, types.ModuleType]: ...
