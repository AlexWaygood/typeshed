...
def unique[_EnumerationT: type[Enum]](enumeration: _EnumerationT) -> _EnumerationT: ...
...
if sys.version_info >= (3, 11):
    ...
    def global_enum[_EnumerationT: type[Enum]](cls: _EnumerationT, update_str: bool = False) -> _EnumerationT: ...
...
if sys.version_info >= (3, 11):
    ...
    def pickle_by_enum_name[_EnumMemberT](self: _EnumMemberT, proto: int) -> tuple[Callable[..., Any], tuple[type[_EnumMemberT], str]]: ...
