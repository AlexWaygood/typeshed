...
@overload
def POINTER[_CT: _CData](type: type[_CT], /) -> type[_Pointer[_CT]]: ...
def pointer[_CT: _CData](obj: _CT, /) -> _Pointer[_CT]: ...
...
@final
@type_check_only
class _CField[_CT: _CData, _GetT, _SetT]:
    offset: int
    size: int
...
def Py_DECREF[_T](o: _T, /) -> _T: ...
def Py_INCREF[_T](o: _T, /) -> _T: ...
