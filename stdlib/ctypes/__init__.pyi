...
class LibraryLoader[_DLLT: CDLL]:
...
def cast[_CastT: _CanCastTo](obj: _CData | _CDataType | _CArgObject | int, typ: type[_CastT]) -> _CastT: ...
...
def ARRAY[_CT: _CData](typ: _CT, len: int) -> Array[_CT]: ...  # Soft Deprecated, no plans to remove
