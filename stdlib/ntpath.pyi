...
if sys.platform == "win32":
    if sys.version_info >= (3, 10):
        @overload
        def realpath[AnyStr: (bytes, str)](path: PathLike[AnyStr], *, strict: bool = False) -> AnyStr: ...
        @overload
        def realpath[AnyStr: (bytes, str)](path: AnyStr, *, strict: bool = False) -> AnyStr: ...
    else:
        @overload
        def realpath[AnyStr: (bytes, str)](path: PathLike[AnyStr]) -> AnyStr: ...
        @overload
        def realpath[AnyStr: (bytes, str)](path: AnyStr) -> AnyStr: ...
