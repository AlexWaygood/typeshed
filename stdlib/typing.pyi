...
class ItemsView(MappingView, AbstractSet[tuple[_KT_co, _VT_co]], Generic[_KT_co, _VT_co]):
    ...
    def __and__(self, other: Iterable[Any]) -> AbstractSet[tuple[_KT_co, _VT_co]]: ...
    def __rand__(self, other: Iterable[_T]) -> AbstractSet[_T]: ...
    def __contains__(self, item: object) -> bool: ...
    def __iter__(self) -> Iterator[tuple[_KT_co, _VT_co]]: ...
    def __or__(self, other: Iterable[_T]) -> AbstractSet[tuple[_KT_co, _VT_co] | _T]: ...
    def __ror__(self, other: Iterable[_T]) -> AbstractSet[tuple[_KT_co, _VT_co] | _T]: ...
    def __sub__(self, other: Iterable[Any]) -> AbstractSet[tuple[_KT_co, _VT_co]]: ...
    def __rsub__(self, other: Iterable[_T]) -> AbstractSet[_T]: ...
    def __xor__(self, other: Iterable[_T]) -> AbstractSet[tuple[_KT_co, _VT_co] | _T]: ...
    def __rxor__(self, other: Iterable[_T]) -> AbstractSet[tuple[_KT_co, _VT_co] | _T]: ...

class KeysView(MappingView, AbstractSet[_KT_co]):
    def __init__(self, mapping: Mapping[_KT_co, Any]) -> None: ...  # undocumented
    def __and__(self, other: Iterable[Any]) -> AbstractSet[_KT_co]: ...
    def __rand__(self, other: Iterable[_T]) -> AbstractSet[_T]: ...
    def __contains__(self, key: object) -> bool: ...
    def __iter__(self) -> Iterator[_KT_co]: ...
    def __or__(self, other: Iterable[_T]) -> AbstractSet[_KT_co | _T]: ...
    def __ror__(self, other: Iterable[_T]) -> AbstractSet[_KT_co | _T]: ...
    def __sub__(self, other: Iterable[Any]) -> AbstractSet[_KT_co]: ...
    def __rsub__(self, other: Iterable[_T]) -> AbstractSet[_T]: ...
    def __xor__(self, other: Iterable[_T]) -> AbstractSet[_KT_co | _T]: ...
    def __rxor__(self, other: Iterable[_T]) -> AbstractSet[_KT_co | _T]: ...
