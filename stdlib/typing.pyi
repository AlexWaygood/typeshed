...
def overload[_F: Callable[..., Any]](func: _F) -> _F: ...
def no_type_check[_F: Callable[..., Any]](arg: _F) -> _F: ...
def no_type_check_decorator[**_P, _T](decorator: Callable[_P, _T]) -> Callable[_P, _T]: ...

# This itself is only available during type checking
def type_check_only[_FT: Callable[..., Any] | type](func_or_cls: _FT) -> _FT: ...
...
def runtime_checkable[_TC: type[object]](cls: _TC) -> _TC: ...
@runtime_checkable
...
if sys.version_info >= (3, 11):
    def reveal_type[_T](obj: _T, /) -> _T: ...
    def assert_never(arg: Never, /) -> Never: ...
    def assert_type[_T](val: _T, typ: Any, /) -> _T: ...
...
if sys.version_info >= (3, 12):
    def override[_F: Callable[..., Any]](method: _F, /) -> _F: ...
    @final
    class TypeAliasType:
