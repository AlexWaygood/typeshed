...
@overload
def format[_T: (str, bytes)](tokens, formatter: Formatter[_T], outfile: None = None) -> _T: ...
@overload
def highlight(code, lexer, formatter: Formatter[_T], outfile: SupportsWrite[_T]) -> None: ...
@overload
def highlight[_T: (str, bytes)](code, lexer, formatter: Formatter[_T], outfile: None = None) -> _T: ...
