...
def get_module_constant[_T](module, symbol, default: _T | int = -1, paths: Incomplete | None = None) -> _T | int | None | Any: ...
def extract_constant[_T](code, symbol, default: _T | int = -1) -> _T | int | None | Any: ...
