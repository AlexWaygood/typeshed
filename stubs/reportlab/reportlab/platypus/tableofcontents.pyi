...
@overload
def makeTuple[_T](x: tuple[_T, ...]) -> tuple[_T, ...]: ...
@overload
def makeTuple[_T](x: list[_T]) -> tuple[_T, ...]: ...
@overload
def makeTuple[_T](x: _T) -> tuple[_T, ...]: ...
...
def listdiff[_T](l1: list[Any], l2: list[_T]) -> tuple[int, list[_T]]: ...
