...
@overload
def get_translations[_T](languages: Iterable[str] | None = None, *, getter: Callable[[Iterable[str]], _T]) -> _T: ...
@overload
def get_translations[_T](languages: Iterable[str] | None, getter: Callable[[Iterable[str]], _T]) -> _T: ...
