...
@overload
def from_pandas_adjacency[_G: Graph[Hashable]](df: _DataFrame, create_using: type[_G]) -> _G: ...
@overload
...
@overload
def from_pandas_edgelist[_G: Graph[Hashable]](
    df: _DataFrame,
    source: str | int,
    target: str | int,
...
@overload
def from_numpy_array[_G: Graph[Hashable]](A: numpy.ndarray[Incomplete, Incomplete], parallel_edges: bool = False, *, create_using: type[_G]) -> _G: ...
@overload
def from_numpy_array[_G: Graph[Hashable]](A: numpy.ndarray[Incomplete, Incomplete], parallel_edges: bool, create_using: type[_G]) -> _G: ...
