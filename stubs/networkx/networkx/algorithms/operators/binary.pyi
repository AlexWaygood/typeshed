...
@_dispatchable
def compose[_X: Hashable, _Y: Hashable](G: DiGraph[_X], H: DiGraph[_Y]) -> DiGraph[_X | _Y]: ...
@_dispatchable
def union[_X: Hashable, _Y: Hashable](G: DiGraph[_X], H: DiGraph[_Y], rename=()) -> DiGraph[_X | _Y]: ...
