...
def time_now() -> float: ...
def dictkeys[_KT](dct: Mapping[_KT, Any]) -> list[_KT]: ...
def dictvalues[_VT_co](dct: Mapping[Any, _VT_co]) -> list[_VT_co]: ...
def dict_iteritems[_KT, _VT_co](dct: Mapping[_KT, _VT_co]) -> ItemsView[_KT, _VT_co]: ...
def dict_itervalues[_VT_co](dct: Mapping[Any, _VT_co]) -> ValuesView[_VT_co]: ...
