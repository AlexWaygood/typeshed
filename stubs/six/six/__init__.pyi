...
def iterkeys[_K](d: Mapping[_K, Any]) -> _Iterator[_K]: ...
def itervalues[_V](d: Mapping[Any, _V]) -> _Iterator[_V]: ...
def iteritems[_K, _V](d: Mapping[_K, _V]) -> _Iterator[tuple[_K, _V]]: ...
def viewkeys[_K](d: Mapping[_K, Any]) -> KeysView[_K]: ...
def viewvalues[_V](d: Mapping[Any, _V]) -> ValuesView[_V]: ...
def viewitems[_K, _V](d: Mapping[_K, _V]) -> ItemsView[_K, _V]: ...
def b(s: str) -> bytes: ...
def u(s: str) -> str: ...
...
def byte2int[_T](obj: SupportsGetItem[int, _T]) -> _T: ...
...
def python_2_unicode_compatible[_T](klass: _T) -> _T: ...
