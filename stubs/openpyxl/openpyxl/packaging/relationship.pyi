...
# `cls` cannot be None
@overload
def get_rel[_SerialisableRelTypeT: CacheDefinition | RecordList | TableDefinition](
...
@overload
def get_rel[_SerialisableT: Serialisable](archive: ZipFile, deps: RelationshipList, id: str, cls: type[_SerialisableT]) -> _SerialisableT: ...
