...
@overload
def pofile[_TP: POFile](pofile: str | Path, *, klass: type[_TP], **kwargs: Any) -> _TP: ...
@overload
def pofile(pofile: str | Path, **kwargs: Any) -> POFile: ...
@overload
def mofile[_TM: MOFile](mofile: str, *, klass: type[_TM], **kwargs: Any) -> _TM: ...
@overload
...
class _POFileParser[_TP: POFile]:
    fhandle: IO[str]
    instance: _TP
...
class _MOFileParser[_TM: MOFile]:
    fhandle: IO[bytes]
    instance: _TM
