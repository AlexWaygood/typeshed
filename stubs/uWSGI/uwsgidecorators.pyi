...
class _spoolraw[**_P, _SR: Literal[0, -1, -2] | None]:
    f: Callable[_P, _SR]
    pass_arguments: bool
...
@overload
def spoolraw[**_P, _SR: Literal[0, -1, -2] | None](f: Callable[_P, _SR], pass_arguments: bool = False) -> _spoolraw[_P, _SR]: ...
@overload
def spoolraw(f: None = None, pass_arguments: bool = False) -> Callable[[Callable[_P, _SR]], _spoolraw[_P, _SR]]: ...
@overload
def spool[**_P, _SR: Literal[0, -1, -2] | None](f: Callable[_P, _SR], pass_arguments: bool = False) -> _spool[_P, _SR]: ...
@overload
def spool(f: None = None, pass_arguments: bool = False) -> Callable[[Callable[_P, _SR]], _spool[_P, _SR]]: ...
@overload
def spoolforever[**_P, _SR: Literal[0, -1, -2] | None](f: Callable[_P, _SR], pass_arguments: bool = False) -> _spoolforever[_P, _SR]: ...
@overload
def spoolforever(f: None = None, pass_arguments: bool = False) -> Callable[[Callable[_P, _SR]], _spoolforever[_P, _SR]]: ...

class mulefunc[**_P, _T]:
    fname: str | None
    mule: int
    @overload
